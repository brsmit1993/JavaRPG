...
public class LocationTown extends Location implements LocationBase {
	
	private Chance chance = new Chance();
	
	String localName = "Small Town"; // name displayed in console
	
	int battleDif = 1; // dicatates monster that will appear / battle difficulty
	...
	public void event(int chanceNum) {
		...
		if (chanceNum >= 201)
		{
			...
			TownEvents.getEvent(cha, 0, true);
		}
	}
	/**
	 * @return localName
